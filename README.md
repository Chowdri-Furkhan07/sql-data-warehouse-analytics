...
> _Add 2–3 of your own findings here once you've run the scripts — e.g. "Bikes account for X% of total revenue" or "The top 20% of customers (VIP segment) generate Y% of total sales." Concrete numbers make this section far more compelling to recruiters._
